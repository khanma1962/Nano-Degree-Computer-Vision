...
#             print(f'landmark is  {landmark}')
            ...
            rand_noise = self.rand()  * self.measurement_noise
...
#                 delta_y +=0 
            ...
            delta_x += rand_noise if delta_x < self.measurement_range else 0
            delta_y += rand_noise if delta_y < self.measurement_range else 0
